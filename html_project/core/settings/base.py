...
HTML_PROJECTS_DIR = os.path.join(WEBSITE_ROOT, 'projects')

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.8/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'sJS]\:EmeA@vk2%KtlK?WIZU0."PYx?&Y4)o<zJgUrN!%:l->jVUnZ%Cif,s:Iw.5%WD2H~[X4['
...
map(lambda x: 'projects.%s' % x, 
        filter(
            lambda x:  os.path.isdir(os.path.join(WEBSITE_ROOT, 'projects', x)),
            os.listdir(os.path.join(WEBSITE_ROOT, 'projects'))
              )
    )
